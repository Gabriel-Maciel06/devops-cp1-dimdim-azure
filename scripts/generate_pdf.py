...
pdf.add_text("Video de Demonstracao (YouTube): [COLE SEU LINK DO VIDEO AQUI]", size=10.5, bold=True, color=(0.85, 0.15, 0.2))
pdf.add_text("Swagger UI (Nuvem Azure): http://app-dimdim-rm562795.brazilsouth.azurecontainer.io:8080/swagger-ui.html", size=10)
pdf.add_space(15)

pdf.add_text("RESUMO DOS RECURSOS AZURE (PaaS):", size=13, bold=True, color=(0.1, 0.2, 0.5))
pdf.add_text("- Resource Group: rg-dimdim-rm562795 (Regiao: brazilsouth)", size=10.5)
...
pdf.add_text("az group create --name rg-dimdim-rm562795 --location brazilsouth", size=9)
